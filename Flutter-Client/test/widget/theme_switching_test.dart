...
class MockSettingsBloc extends Mock {
  @override
  SettingsState get state => super.noSuchMethod(
    Invocation.method(#state, []),
    returnValue: const SettingsInitial(),
  );

  @override
  Stream<SettingsState> get stream => super.noSuchMethod(
    Invocation.method(#stream, []),
    returnValue: Stream.value(const SettingsInitial()),
  );
}
